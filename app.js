...
async function loadOcrEngine() {
  ...
  await ocrWorker.setParameters({
    ...
    // PSM 7 = anggap gambar ini SATU BARIS TEKS SAJA (bukan dokumen/paragraf).
    // Tanpa ini, Tesseract salah menebak struktur gambar dan hasil baca
    // jadi berantakan - ini kemungkinan besar penyebab utama hasil ngawur.
...
function preprocessForOcr(sourceCanvas) {
  ...
  // Metode Otsu: cara standar buat nentuin batas hitam/putih paling optimal
  // berdasarkan histogram gambar (lebih akurat dari sekadar rata-rata).
